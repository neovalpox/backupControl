...
async def lifespan(app: FastAPI):
    ...
    logger.info("🚀 Démarrage de BackupControl...")
    ...
    async with AsyncSessionLocal() as session:
        ...
        if not admin_user:
            ...
            logger.info("✅ Utilisateur admin créé (mot de passe: admin123)")
    ...
    logger.info("👋 Arrêt de BackupControl")
...
# IMPORTANT: emails_v2 doit etre AVANT emails pour que les routes specifiques soient prioritaires
app.include_router(emails_v2.router, prefix="/api/emails", tags=["E-mails Analyse"])
