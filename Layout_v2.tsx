      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-200 ease-in-out`}>
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-700">
          <Link to="/" className="flex items-center space-x-2">
            <ServerStackIcon className="w-8 h-8 text-primary-500" />
          ...
          <div className="absolute bottom-20 left-0 right-0 px-4">
            <div className="bg-gray-900/50 rounded-lg p-4 space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-white font-medium">{stats.total_clients || 0}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-green-400 font-medium">{stats.backups_success || 0}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-red-400 font-medium">{stats.backups_failed || 0}</span>
              </div>
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-yellow-400 font-medium">{stats.pending_alerts || 0}</span>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center justify-between h-16 px-4">
            ...
            <div className="flex-1 flex justify-center lg:justify-start lg:ml-4">
              {searchOpen ? (
                ...
                <button
                  ...
                  className="flex items-center px-4 py-2 text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg transition-colors"
                >
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                ...
                {alertCount > 0 && (
                  <span className="absolute -top-1 -right-1 px-1.5 py-0.5 text-xs font-medium rounded-full bg-red-500 text-white min-w-[20px] text-center">
