...
export const emailsApi = {
  ...
  getAnalysisProgress: async () => (await api.get('/emails/analysis-progress')).data,
  getBackupSummary: async () => (await api.get('/emails/backup-summary')).data,
  getAnalyzedEmailDetail: async (id: number) => (await api.get(`/emails/analyzed/${id}`)).data,
};
